...
class SearchAdvForm(forms.Form):
    ...
    tag = forms.MultipleChoiceField(widget=forms.CheckboxSelectMultiple(attrs={'class':'select'}),choices=TAG_CHOICES,required=False)
    difficulty = forms.MultipleChoiceField(widget=forms.CheckboxSelectMultiple(attrs={'class':'select'}),choices=DIFFICULTY_CHOICES)
    ...
    language = forms.MultipleChoiceField(widget=forms.CheckboxSelectMultiple(attrs={'class':'select'}),choices=LANGUAGES_CHOICES)
    game_type_choice = forms.MultipleChoiceField(widget=forms.CheckboxSelectMultiple(attrs={'class':'select'}),choices=GAME_TYPE_CHOICES)
